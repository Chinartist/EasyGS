...
def readColmapCameras(cam_extrinsics, cam_intrinsics, Height, Width, images_folder=None, depths_folder=None,
                      normals_folder=None, alphas_folder=None, extra_attrs_folder=None, preload=True):
    cam_infos = []
    for idx, key in enumerate(cam_extrinsics):
        ...
        extra_attrs = os.path.join(extra_attrs_folder,
                                   image_name.replace(endwith, "npy")) if extra_attrs_folder else None
