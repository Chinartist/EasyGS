...
data_dir="/home/tangyuan/wks/data/static_scene_gs/beijing_roadside" 
trainer = GSer(
        #要么提供COLMAP路径，要么提供相机参数
        colmap_path=f"{data_dir}",
        images_folder=f"{data_dir}/images",
        # alphas_folder=f"{data_dir}/masks",
        pretrained_path="/home/tangyuan/wks/data/static_scene_gs/beijing_roadside/merged.ply",
        ...
        wandb_project="PPGS")
trainer.train()
trainer.save_colmap('/home/tangyuan/wks/data/static_scene_gs/beijing_roadside/optimized_colmap/QG')