...
data_dir = "/home/tangyuan/developer/Tuning-Colors/data/scene/R39_0814"
trainer = GSer(
    # 要么提供COLMAP路径，要么提供相机参数
    colmap_path=f"{data_dir}",
    images_folder=f"{data_dir}/roadside",
    # alphas_folder=f"{data_dir}/masks",
    pretrained_path=f"{data_dir}/merged.ply",
